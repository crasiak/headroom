...
## [0.38.0](https://github.com/crasiak/headroom/compare/v0.37.0...v0.38.0) (2026-09-18)


### Features

* **cache:** add the headroom-cache-ttl offline TTL estimator the docs reference ([#2670](https://github.com/crasiak/headroom/issues/2670)) ([52c7aa2](https://github.com/crasiak/headroom/commit/52c7aa2e6faa9ff5010c84d73fa35936288bbe8a))
* **cli:** add --bedrock-base-url/--bedrock-compression + BEDROCK_TARGET_API_URL ([47a1122](https://github.com/crasiak/headroom/commit/47a11221b1250503821066ae3e6257cf12baf636))
* **cli:** bootstrap starter profiles.toml on first --profile use ([8128934](https://github.com/crasiak/headroom/commit/8128934e95ef54ccea16100ff4c0086668160d62))
* **cli:** headroom-owned Codex config writer for profiles ([04df62e](https://github.com/crasiak/headroom/commit/04df62ecb850f0de9f7d88702b7445782e243195))
* **cli:** profile resolver for --profile wraps ([a11c592](https://github.com/crasiak/headroom/commit/a11c59208dc8317e4ddff7fcdbe87b0cd967f3ce))
* **cli:** share ~/.codex/skills into profile codex homes via symlink ([98062bf](https://github.com/crasiak/headroom/commit/98062bf67433c8b2c30e76a1c9fdbe999a6e7423))
* **cli:** share codex prompts + global AGENTS.md across profiles ([46e6d30](https://github.com/crasiak/headroom/commit/46e6d3030fa6c08738b1cbf49a42cd59ba0a1195))
* **cli:** wrap claude --profile (seed-driven, profile-complete proxy) ([f9ee41d](https://github.com/crasiak/headroom/commit/f9ee41dd9cb2d11ae29c120d08f68fcea4a8218d))
* **cli:** wrap claude auto-detects corelight Bedrock aperture ([d155a48](https://github.com/crasiak/headroom/commit/d155a482dfdcb7b9354b59c1bd8e87a2ec112798))
* **cli:** wrap codex --profile via headroom-owned CODEX_HOME ([f3d874e](https://github.com/crasiak/headroom/commit/f3d874e1b096eee2d04c110720dc3d9e2e691cf5))
* **dashboard:** Cost Saved headline card; label per-row savings as message-only ([#3353](https://github.com/crasiak/headroom/issues/3353)) ([17b0412](https://github.com/crasiak/headroom/commit/17b041235480654ee69d775e38f2f09ffe468e1d))
* **dashboard:** show routing savings for this session and all time ([#3362](https://github.com/crasiak/headroom/issues/3362)) ([a811984](https://github.com/crasiak/headroom/commit/a811984ffb62a866274dda2928f78922101c824b))
* **doctor:** diagnose active Ledger bindings (CRA-458) ([a56e412](https://github.com/crasiak/headroom/commit/a56e412ba84a995fb9193dc3840f4ccfc4b14dec))
* **doctor:** diagnose the active Ledger binding (CRA-458) ([09d8d6f](https://github.com/crasiak/headroom/commit/09d8d6f9e241307578f240b542116f3247940604))
* **doctor:** diagnose the active Ledger binding (CRA-458) ([ae3088d](https://github.com/crasiak/headroom/commit/ae3088d72f3d7595ad483b1b8dc5f7dd6f0b9ab0))
* **proxy/model-router:** add require_tools route condition ([#2362](https://github.com/crasiak/headroom/issues/2362)) ([ae75ca4](https://github.com/crasiak/headroom/commit/ae75ca49a0af04ae03903a4136483f289962dc22))
* **proxy:** add Bedrock aperture passthrough handler ([d1f1f01](https://github.com/crasiak/headroom/commit/d1f1f01e15a3d5c702fa795ee861eef6861f44ca))
* **proxy:** add bedrock_base_url/bedrock_compression to ProxyConfig ([2d26864](https://github.com/crasiak/headroom/commit/2d268648a1f42352c189a35c717b00daa4473c5e))
* **proxy:** full-savings cost card, cache-aware tool-schema pricing, routing-stats seam ([#3351](https://github.com/crasiak/headroom/issues/3351)) ([b8fa3ad](https://github.com/crasiak/headroom/commit/b8fa3ad9bdf77061fe808578fba302941ab4e51e))
* **proxy:** log bedrock passthrough outbound hop (URL + status) ([597615f](https://github.com/crasiak/headroom/commit/597615f9a57316b9442b7d50c993de4b1ece5f71))
* **proxy:** register Bedrock aperture invoke routes ([2732852](https://github.com/crasiak/headroom/commit/27328528bf687764f1c14c292176fce755d83845))
* **transport:** add bounded crash attribution diagnostics ([584f22a](https://github.com/crasiak/headroom/commit/584f22a342c19dd3320d4f4055f9a82320c9f5fd))
* **transport:** add isolated local protocol ([7562021](https://github.com/crasiak/headroom/commit/7562021cf0ec78ca9a40235937e31ac3ce62e0f6))
* **transport:** add isolated local protocol ([d66b07b](https://github.com/crasiak/headroom/commit/d66b07bcceeb3bd138320e44bc52911010ee226b))
* **transport:** consolidate deployed Ledger runtime on the fork ([ebfaceb](https://github.com/crasiak/headroom/commit/ebfaceba44bbb3a9f80f3f4df67feb9d2eaa5a1e))
* **transport:** consolidate deployed Ledger support on the personal fork ([6393f38](https://github.com/crasiak/headroom/commit/6393f389d8326c2e858916dafec5945a20bd9ea8))
* **transport:** managed per-launch transport runtime ([3aa41c1](https://github.com/crasiak/headroom/commit/3aa41c1bbaafb7240c6ff8c1aa5bee3d0ec24e37))
* **vertex:** add Gemini 3.8 Flash agent benchmark suite ([#3371](https://github.com/crasiak/headroom/issues/3371)) ([e67b3c8](https://github.com/crasiak/headroom/commit/e67b3c8a29443a60d6b0018fb22f525c5cd7e709))


### Bug Fixes

* attach stdin for docker-native MCP stdio ([#3447](https://github.com/crasiak/headroom/issues/3447)) ([a490bba](https://github.com/crasiak/headroom/commit/a490bba83fdf20b0ddee183e6af64244a0cddb38))
* **auth:** match the Bearer auth scheme case-insensitively (RFC 7235) ([#3219](https://github.com/crasiak/headroom/issues/3219)) ([75105e2](https://github.com/crasiak/headroom/commit/75105e23b43a6ca156e1cbe9ab7ec9358a0c0d76))
* **cache:** keep cached-prefix replay after background recompression ([#3380](https://github.com/crasiak/headroom/issues/3380)) ([aebe989](https://github.com/crasiak/headroom/commit/aebe98954ee33ee9da96985cbf0f046b2f49ce22))
* **ccr:** log the exception type when a CCR continuation call fails ([#3137](https://github.com/crasiak/headroom/issues/3137)) ([9f75f91](https://github.com/crasiak/headroom/commit/9f75f91dc566128914cb4f14e9950a98264603cd))
* **changelog-gen:** raise on git failure and remove unreachable fallback regex ([#1247](https://github.com/crasiak/headroom/issues/1247)) ([4e1f776](https://github.com/crasiak/headroom/commit/4e1f7769d7b899bad25c89841b79113d3362e84e))
* **ci:** isolate installer fixtures and lint fork contributions ([01fa8f6](https://github.com/crasiak/headroom/commit/01fa8f6b32b0a468343bb78f07e454bc7ee268cc))
* **cli:** _launch_tool bedrock param; keep ~/.codex untouched in profile mode ([2dcbbae](https://github.com/crasiak/headroom/commit/2dcbbae165aefec81dfdfd9d52221297b9917153))
* **cli:** friendly error for malformed profiles.toml (ValueError) ([f2ada41](https://github.com/crasiak/headroom/commit/f2ada4100bb895a9736411a5e4043fee794c83e3))
* **cli:** guard codex owned-config against silent proxy-bypass ([69fef4d](https://github.com/crasiak/headroom/commit/69fef4d50b5441f74a2d025ac25e3af8de8cf5ca))
* **cli:** honor --port in profile-mode owned codex config; memory off in profile mode ([f7721ec](https://github.com/crasiak/headroom/commit/f7721ec5a46a33e41378c965aa0aade2d9db538b))
* **cli:** honor HEADROOM_BEDROCK_COMPRESSION in both CLI paths ([72a141c](https://github.com/crasiak/headroom/commit/72a141ccd63adb72fa3ff9bcfbe0057f78c45091))
* **cli:** scrub ambient bedrock env in no-bedrock profiles; friendly resolver errors ([8f90be2](https://github.com/crasiak/headroom/commit/8f90be29df35d1a7007c34b274d517ef4a96315c))
* **cli:** treat codex skills/.system boilerplate as empty when linking ([c1962cf](https://github.com/crasiak/headroom/commit/c1962cf7660fb5df9a1c020637889ee27074acc6))
* **compression:** compress cache_control blocks in the request's final message ([#3483](https://github.com/crasiak/headroom/issues/3483)) ([55d7e64](https://github.com/crasiak/headroom/commit/55d7e647e957b0255241d843eeeac6e5e7e06382))
* **compression:** pause AST compression per language after repeated invalid-syntax discards ([#3387](https://github.com/crasiak/headroom/issues/3387)) ([dde83c9](https://github.com/crasiak/headroom/commit/dde83c914687a272ed5d5b8e2a04095b3d157f2f))
* **compression:** preserve Bash control flow ([#3425](https://github.com/crasiak/headroom/issues/3425)) ([ee90207](https://github.com/crasiak/headroom/commit/ee902074a04d691434a3485eea4428732058f159))
* **compression:** protect Bash before the tree-sitter guard, not after ([#3435](https://github.com/crasiak/headroom/issues/3435)) ([ee6f9db](https://github.com/crasiak/headroom/commit/ee6f9db25b9e9ab08a97de9c33b4bba8d9c55924))
* **dashboard:** make every control keyboard operable and name icon-only controls ([#3434](https://github.com/crasiak/headroom/issues/3434)) ([15debbe](https://github.com/crasiak/headroom/commit/15debbef7f17c8960d6d82dfffedaba4291c057d))
* **dashboard:** report Headroom-attributable cost savings, not the provider cache discount ([#3356](https://github.com/crasiak/headroom/issues/3356)) ([bfe3c78](https://github.com/crasiak/headroom/commit/bfe3c7873f93d281ca55316d42faa2262d946a2c))
* **deps:** install on Python 3.14 from prebuilt wheels only ([#3631](https://github.com/crasiak/headroom/issues/3631)) ([b8b222f](https://github.com/crasiak/headroom/commit/b8b222f9403878efe08376eac71a626caf1920d6))
* **deps:** remediate vulnerable CLI and plugin dependency trees ([#3521](https://github.com/crasiak/headroom/issues/3521)) ([4263da1](https://github.com/crasiak/headroom/commit/4263da12b585387d87a922e34c6101ae5e5dd0aa))
* **deps:** upgrade rustls to 0.23.45 for RUSTSEC-2026-0285 ([#3584](https://github.com/crasiak/headroom/issues/3584)) ([b256d25](https://github.com/crasiak/headroom/commit/b256d254c06421e9d43493007ef20ea31bae2b9b))
* **doctor:** detect Codex routing via active provider base_url ([#2618](https://github.com/crasiak/headroom/issues/2618)) ([4794d68](https://github.com/crasiak/headroom/commit/4794d688a96b1d1442662f163d2b579f08aa030a))
* **doctor:** satisfy binding and probe type contracts ([c2cc002](https://github.com/crasiak/headroom/commit/c2cc002a49f1775248921e4c08a3b7d80111a0bd))
* **e2e:** lock CLI dependencies for reproducible wrap builds ([#3512](https://github.com/crasiak/headroom/issues/3512)) ([5abcdbd](https://github.com/crasiak/headroom/commit/5abcdbd041a680c42a4df482eab62f2e0e8ee7fa))
* **e2e:** pin npm to avoid Node 22 plugin install crash ([8f3a057](https://github.com/crasiak/headroom/commit/8f3a0574bd727141250548539b144872fe5f23de))
* fix security issue in server.py ([#3593](https://github.com/crasiak/headroom/issues/3593)) ([97aa949](https://github.com/crasiak/headroom/commit/97aa949924fa6d8d0f008efa47589351e9f10004))
* hold Cursor's read_file byte-exact too ([d02e7df](https://github.com/crasiak/headroom/commit/d02e7df5889b3f2dcd229ddfb6ca397ab3987b84))
* keep dashboard route boundaries out of upstream passthrough ([#3324](https://github.com/crasiak/headroom/issues/3324)) ([213b371](https://github.com/crasiak/headroom/commit/213b37158fb9fa7287d7d5884c7df43800821995))
* keep file-read tool output byte-exact through the lossless fold ([59499f7](https://github.com/crasiak/headroom/commit/59499f73ac49b45b7bbe75da018f2eea50e14d5a))
* **kompress:** append the CCR marker whenever the saving pays for it ([#3484](https://github.com/crasiak/headroom/issues/3484)) ([7bd4dba](https://github.com/crasiak/headroom/commit/7bd4dbaf8f40d00f579f1cfca4bc56716f508d85))
* **langchain:** implement get_metrics() on HeadroomChatModel ([#3446](https://github.com/crasiak/headroom/issues/3446)) ([#3459](https://github.com/crasiak/headroom/issues/3459)) ([dba5d2f](https://github.com/crasiak/headroom/commit/dba5d2f1e7b0abf65bce5c0ce2e9275857e11a18))
* **langchain:** make the integration work on LangChain 1.x, and document it ([#3399](https://github.com/crasiak/headroom/issues/3399)) ([5d025f7](https://github.com/crasiak/headroom/commit/5d025f7a03870a402918e6425ca9fcd40400edb2))
* **learn:** count each tool call once per tool_call_id when detecting loops ([#3462](https://github.com/crasiak/headroom/issues/3462)) ([4088a65](https://github.com/crasiak/headroom/commit/4088a65bb7bc9ef8aa1bf4cb59c3da8cecef4820))
* **learn:** derive loop signature from tool input identity, not display summary ([#3461](https://github.com/crasiak/headroom/issues/3461)) ([f6b9fc0](https://github.com/crasiak/headroom/commit/f6b9fc09e33ad091f1cf14dd60285965167d4c85))
* **learn:** distinguish Grep and Glob searches by path ([#3455](https://github.com/crasiak/headroom/issues/3455)) ([f302a38](https://github.com/crasiak/headroom/commit/f302a38e8fed6d45a3fb3a07ada97043a9a00dd4))
* **learn:** echo live progress during claude-cli analysis ([#3158](https://github.com/crasiak/headroom/issues/3158)) ([4c6bd3e](https://github.com/crasiak/headroom/commit/4c6bd3e8fc13d5b7b73092a6db775c6e6a1a69df))
* **learn:** guard session-derived path checks against PermissionError in gemini/grok plugins ([#2522](https://github.com/crasiak/headroom/issues/2522)) ([60bfe8b](https://github.com/crasiak/headroom/commit/60bfe8be9356217c4d5e493e10ec9cfdbe0bf716))
* **learn:** retry LLM analysis with a smaller digest when the prompt overflows the context window ([#3404](https://github.com/crasiak/headroom/issues/3404)) ([d329a04](https://github.com/crasiak/headroom/commit/d329a04b4b553a66a3a566a92a1510919cb688f3))
* **learn:** show both ends of CLI output on a parse failure ([#3517](https://github.com/crasiak/headroom/issues/3517)) ([cb3ab61](https://github.com/crasiak/headroom/commit/cb3ab61d4d57fa04208b8cde75f56a32cae048c8))
* **litellm:** preserve Anthropic thinking blocks; fix OpenAI-in reasoning passthrough ([#3586](https://github.com/crasiak/headroom/issues/3586)) ([9f32800](https://github.com/crasiak/headroom/commit/9f32800b86ad277201c2a2ce75192534f8e94b03))
* **mcp:** report a plugin-provided Serena that reconcile cannot see ([#3578](https://github.com/crasiak/headroom/issues/3578)) ([35b1156](https://github.com/crasiak/headroom/commit/35b11564c6217c358094732618d21eb74503aa47))
* **memory:** honor project root override for Anthropic CCR ([#3606](https://github.com/crasiak/headroom/issues/3606)) ([91fd58d](https://github.com/crasiak/headroom/commit/91fd58d1df37443690292115476001d7fa141bfc))
* **merge:** reapply v0.31 bedrock naming decisions after v0.32 rebase ([d0c13bf](https://github.com/crasiak/headroom/commit/d0c13bf95e941fbcff9b83f7e4e512f8655c5bf7))
* **merge:** repair v0.31 merge fallout in wrap + bedrock route tests ([e0f7641](https://github.com/crasiak/headroom/commit/e0f7641e6fbd5a19ed1de582e91043e6d9583562))
* never grep-fold timestamped logs, size-weight savings, warn on no-op model limits ([#3419](https://github.com/crasiak/headroom/issues/3419)) ([73a6edb](https://github.com/crasiak/headroom/commit/73a6edbe83af716bb833da5d902dd55afa6dab40))
* **openclaw:** delegate native compaction ([#2304](https://github.com/crasiak/headroom/issues/2304)) ([eb4da64](https://github.com/crasiak/headroom/commit/eb4da64774049261b07da2d5ebfc13f2a8b61070))
* **output-savings:** count conversations, not requests, in the holdout gate ([#3460](https://github.com/crasiak/headroom/issues/3460)) ([53631ad](https://github.com/crasiak/headroom/commit/53631adb15310ef7d6e257414b24733d99b2c9ca))
* **perf:** a bad savings row must not take down the whole report ([7b3d226](https://github.com/crasiak/headroom/commit/7b3d226598fec88b5766bcf171cdd7f2a5d1cd3b))
* protect Cursor's read_file in the core, not only in the plugin ([e23e739](https://github.com/crasiak/headroom/commit/e23e73943bb636e89d8b9884286db4b17dea4ce4))
* **proxy/memory:** fail open when backend init errors instead of 500ing the request ([#3257](https://github.com/crasiak/headroom/issues/3257)) ([3eba2d6](https://github.com/crasiak/headroom/commit/3eba2d606647ece6e82366afeb1ed3e2ab99c47b))
* **proxy/openai:** keep /v1/responses savings triple coherent when schema savings exceed message tokens ([#3106](https://github.com/crasiak/headroom/issues/3106)) ([7278b5c](https://github.com/crasiak/headroom/commit/7278b5cbf83ff83c444eb2ffdf82790af2eb9fc0))
* **proxy:** bound decompressed request bodies to close a zip-bomb DoS ([#3325](https://github.com/crasiak/headroom/issues/3325)) ([25a4e71](https://github.com/crasiak/headroom/commit/25a4e71b295f4bc7e50a7fd87379c1e25436c980))
* **proxy:** expose bedrock_api_url on /health + check it in _ensure_proxy ([4761549](https://github.com/crasiak/headroom/commit/4761549a61aebdd3acdb2b4a53c4835ee97027ed))
* **proxy:** gateway turn contract for /v1/compress behind a compress-turn seam ([#3605](https://github.com/crasiak/headroom/issues/3605)) ([d9757dc](https://github.com/crasiak/headroom/commit/d9757dcc6b693a02d484b1695d5821f7dc8ff6f0))
* **proxy:** gateway turn fixes found by benchmarking behind a gateway ([#3619](https://github.com/crasiak/headroom/issues/3619)) ([aceff2e](https://github.com/crasiak/headroom/commit/aceff2ea9dbd09a9660eca930358db27322c5763))
* **proxy:** honor compression controls for Anthropic auxiliary passes ([#3400](https://github.com/crasiak/headroom/issues/3400)) ([fb79055](https://github.com/crasiak/headroom/commit/fb79055b3639db32790e5b559ad3190cbaf9f6f7))
* **proxy:** keep json_bloat waste signals out of the catch-all lifetime bucket ([#3430](https://github.com/crasiak/headroom/issues/3430)) ([e59cf10](https://github.com/crasiak/headroom/commit/e59cf1012a2b277689555833fd221a92279f777d))
* **proxy:** prefer explicit proxy auth header ([#3422](https://github.com/crasiak/headroom/issues/3422)) ([f3965f7](https://github.com/crasiak/headroom/commit/f3965f7c59ce10720bf7a0e5f26e8641ff4cca59))
* **proxy:** protect Codex exec file reads on the Responses path ([#3621](https://github.com/crasiak/headroom/issues/3621)) ([2c56a1b](https://github.com/crasiak/headroom/commit/2c56a1b3a7b991a42858543f6086e0a4936dbf2b))
* **proxy:** record streaming upstream 5xx as failed instead of success ([#2682](https://github.com/crasiak/headroom/issues/2682)) ([4949cd5](https://github.com/crasiak/headroom/commit/4949cd5594f4e13a00f7dd6bf13fa4f9d8e21575))
* **proxy:** repair tool-search history in place so signed thinking blocks keep their coordinates ([#3457](https://github.com/crasiak/headroom/issues/3457)) ([68359c0](https://github.com/crasiak/headroom/commit/68359c056cc9964dd0d0add39d1c8e93e7ea0027))
* **proxy:** support Codex Live HTTP call creation ([#3464](https://github.com/crasiak/headroom/issues/3464)) ([53982ae](https://github.com/crasiak/headroom/commit/53982aefb8014211d13324ad897875a2f80139b5))
* **proxy:** write per-port proxy logs so concurrent instances stop truncating each other ([#3204](https://github.com/crasiak/headroom/issues/3204)) ([3d3c629](https://github.com/crasiak/headroom/commit/3d3c629a9f349ed0f89102e32599aacea32e0b16))
* **read-maturation:** book matured Read savings once, not on every replay ([#3414](https://github.com/crasiak/headroom/issues/3414)) ([85f58a9](https://github.com/crasiak/headroom/commit/85f58a9a7a64b4120fd95ac1d2b107348206908a))
* **release:** use Node 24 for npm packaging and publishing ([#3516](https://github.com/crasiak/headroom/issues/3516)) ([aab500b](https://github.com/crasiak/headroom/commit/aab500b8c5286787d6c112299b8ec458f6de3c55))
* **route_advice:** per-inbound-protocol native providers (enable OpenAI-in → Claude-out) ([#3585](https://github.com/crasiak/headroom/issues/3585)) ([dc28413](https://github.com/crasiak/headroom/commit/dc28413fd9ab538970cc3497d37dda2d1ec8f7a4))
* **savings:** count compression savings once per conversation, not once per turn ([#3480](https://github.com/crasiak/headroom/issues/3480)) ([427fa76](https://github.com/crasiak/headroom/commit/427fa76f60802d1048d7686f791f12c57206e14c))
* serialize PyTorch device transfers with Kompress execution ([#3601](https://github.com/crasiak/headroom/issues/3601)) ([3dfa7da](https://github.com/crasiak/headroom/commit/3dfa7daadbabfc60707b695c1d992066dc71a41b))
* **shaper:** measure output-token steering, and stop claiming savings we did not measure ([#3377](https://github.com/crasiak/headroom/issues/3377)) ([1390d89](https://github.com/crasiak/headroom/commit/1390d897155e69f8b4554eed5641c2e523860d0f))
* stabilize release checks and consolidate dependency updates ([#3531](https://github.com/crasiak/headroom/issues/3531)) ([04cdf79](https://github.com/crasiak/headroom/commit/04cdf79ab0a8423d88148ba63e960ac6b4007b9c))
* **stats:** gate the output-shaping claim on the shaper being active ([#3386](https://github.com/crasiak/headroom/issues/3386)) ([074f0ae](https://github.com/crasiak/headroom/commit/074f0ae9df50abc15a5ec10d05f57d165436f664))
* **storage:** parse absolute Windows paths from URLs ([#3475](https://github.com/crasiak/headroom/issues/3475)) ([db5ed58](https://github.com/crasiak/headroom/commit/db5ed5822a34b16a813eb5e544cbe8d1f0435eb1))
* **test:** exercise mocked Windows proxy termination helper ([1fe94f4](https://github.com/crasiak/headroom/commit/1fe94f476fc2c8fb0e9c138b5f4bec27c8206d55))
* **tests:** exercise prepare-only wiring without proxy extras ([09be367](https://github.com/crasiak/headroom/commit/09be3677938177226b2516bb435c4c524f9b42c4))
* **tests:** isolate persisted settings from developer state ([#3449](https://github.com/crasiak/headroom/issues/3449)) ([0d99e55](https://github.com/crasiak/headroom/commit/0d99e5595de2eaf3a0642b17c0370230c8055e7d))
* **tokenizers:** estimate replayed thinking from text and signature size ([#3482](https://github.com/crasiak/headroom/issues/3482)) ([9ed95c3](https://github.com/crasiak/headroom/commit/9ed95c3806432e2b8df8849e60077535d6c1b3a8))
* **transforms:** classify grep -A/-B/-C context lines as search results ([#3599](https://github.com/crasiak/headroom/issues/3599)) ([f085c47](https://github.com/crasiak/headroom/commit/f085c4740296298860ed95f5edf8950d29ea206c))
* **transforms:** isolate ContentRouter per-request runtime state across concurrent requests ([#3556](https://github.com/crasiak/headroom/issues/3556)) ([0bef398](https://github.com/crasiak/headroom/commit/0bef3981107a13aa3b0c1f8b018766e3c3965337))
* **transport:** tolerate unavailable parent observations ([f3e5e69](https://github.com/crasiak/headroom/commit/f3e5e69c002f8d5ac5b621fef339f045781501b9))
* **transport:** use UTF-8 subprocess wrapper ([8647bb2](https://github.com/crasiak/headroom/commit/8647bb2d945a74f0d379f35eee5473e020d386e4))
* **wrap:** derive claude proxy/vertex URLs from effective_port ([29b41da](https://github.com/crasiak/headroom/commit/29b41da3384cf7cb667208e7d298580f35170a71))
* **wrap:** isolate proxy sys.path from agent cwd via PYTHONSAFEPATH ([8c0e179](https://github.com/crasiak/headroom/commit/8c0e1796fd26a2e4bd0c175771ca85c178d27743))
* **wrap:** profile-mode codex launches via _launch_tool again ([c20fda7](https://github.com/crasiak/headroom/commit/c20fda7051b497ffcb09768d4edd99c1785545d9))


### Performance Improvements

* **cache:** purge expired CCR rows by deadline instead of decoding every payload ([#3465](https://github.com/crasiak/headroom/issues/3465)) ([389e45c](https://github.com/crasiak/headroom/commit/389e45cdde3b8c95f300469c012062d22dbdd437))
* **ccr:** bound retrieval history with a deque instead of reslicing ([#3471](https://github.com/crasiak/headroom/issues/3471)) ([3169935](https://github.com/crasiak/headroom/commit/316993585854c001b4ed71ac3eb67cc90f6c49ad))
* **dashboard:** poll once at a time and initialize once ([#3470](https://github.com/crasiak/headroom/issues/3470)) ([3201bab](https://github.com/crasiak/headroom/commit/3201bab560088ee81b7638c66c4fc0d142cde3fb))
* render the savings each source actually reported ([56f809c](https://github.com/crasiak/headroom/commit/56f809ce39879205a0b936ececa470956e3ab3d9))


### Dependencies

* bump baseline-browser-mapping from 2.10.16 to 2.11.21 in /docs ([#3501](https://github.com/crasiak/headroom/issues/3501)) ([0fcdf21](https://github.com/crasiak/headroom/commit/0fcdf21106c81cc0491d8477e1888e4c77dd2be8))
* bump next from 16.3.0 to 16.3.4 in /docs ([#3499](https://github.com/crasiak/headroom/issues/3499)) ([2503bd7](https://github.com/crasiak/headroom/commit/2503bd7b8d1f237f7db7401c74157619849392c1))
* bump sharp from 0.35.3 to 0.35.4 in /docs ([#3500](https://github.com/crasiak/headroom/issues/3500)) ([d6ad35d](https://github.com/crasiak/headroom/commit/d6ad35d472ef549a8cec922d97831244fd69447d))
* bump vitest from 4.1.10 to 5.0.0 in /plugins/openclaw ([#3498](https://github.com/crasiak/headroom/issues/3498)) ([bb057d2](https://github.com/crasiak/headroom/commit/bb057d2c62bcdcfd97e04d9f3ae32bc0dab096c6))
* bump vitest from 4.1.10 to 5.0.0 in /sdk/typescript ([#3496](https://github.com/crasiak/headroom/issues/3496)) ([6f1251f](https://github.com/crasiak/headroom/commit/6f1251f6f3b723d7dfe206b05993b30d043b24e5))


### Code Refactoring

* **cli:** document port pinning, harden profile resolver errors+edges ([6be31fa](https://github.com/crasiak/headroom/commit/6be31fa9f19f33c9504917d8290213aedca52c80))
* **cli:** extract+test bedrock child-env; align _TRUTHY; warn on dual mode ([6b0fa82](https://github.com/crasiak/headroom/commit/6b0fa82ef4667f62244ffbb1df839f3e14851abc))
* **cli:** tidy _resolve_claude_profile (dataclasses.replace, type, echo) ([e126e54](https://github.com/crasiak/headroom/commit/e126e5473e9a4c71f966d59a606579cad1dd3b16))
* **proxy:** delete duplicate semantic_cache_key module ([#3472](https://github.com/crasiak/headroom/issues/3472)) ([e9c6276](https://github.com/crasiak/headroom/commit/e9c6276e249112d9f30bc2ebb2a87a9d229139d9))
* **proxy:** type bedrock_compression as Literal; clarify compression gaps ([0a3e075](https://github.com/crasiak/headroom/commit/0a3e0753fe8ecd42595fee03479ca9056c7eb3e6))
